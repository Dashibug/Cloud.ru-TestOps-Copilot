...
Автоматически разбирает UI-требования и OpenAPI-спеки, генерирует ручные тесты, полноценные автотесты, выполняет ревью, автоматически исправляет найденные дефекты в тестах.
...
Специально испольуются две модели:
